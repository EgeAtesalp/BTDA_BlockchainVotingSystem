...
describe("Working Debug Test", function () {
  ...
  it("Step 2: Should create districts", async function () {
    ...
    console.log("District count after creation:", await election.districtCount());
    
    const district = await election.getDistrict(0);
    console.log("District 0:", district);
    
    expect(await election.districtCount()).to.equal(1);
  });
  ...
  it("Step 3: Should add candidates", async function () {
    ...
    await election.addCandidate("Bob", "Conservative");
    console.log("Candidate count after additions:", await election.candidateCount());
